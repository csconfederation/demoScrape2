...
//	if game.Flags.RoundIntegrityStart != game.Flags.RoundIntegrityEnd {
//		return
//	}
//	if game.Flags.RoundIntegrityEnd != game.Flags.RoundIntegrityEndOfficial {
//		return
//	}
//
...
//
//	//check team stats
//	winnerTeamStats := game.PotentialRound.TeamStats[game.PotentialRound.WinnerClanName]
//	winnerTeamStats.PistolsW = winnerTeamStats.Pistols
//	winnerTeamStats.FourVFiveW = winnerTeamStats.FourVFiveS
//	winnerTeamStats.FiveVFourW = winnerTeamStats.FiveVFourS
//	winnerTeamStats.TRW = winnerTeamStats.TR
//	winnerTeamStats.CtRW = winnerTeamStats.CtR
//
//	//set the clutch
//	if game.PotentialRound.WinnerENUM == int(common.TeamTerrorists) && game.Flags.TClutchSteam != 0 {
//		winnerTeamStats.Clutches = 1
...
//		}
//	} else if game.PotentialRound.WinnerENUM == int(common.TeamCounterTerrorists) && game.Flags.CtClutchSteam != 0 {
//		winnerTeamStats.Clutches = 1
...
//		if !game.Rounds[i].IntegrityCheck {
//			return
//		}
//		if game.Rounds[i].KnifeRound {
//			return
//		}
//		if validRoundExists {
//			return
